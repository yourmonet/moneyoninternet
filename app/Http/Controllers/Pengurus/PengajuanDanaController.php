...
class PengajuanDanaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pengurus.pengajuan-dana.index', compact('pengajuans'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pengurus.pengajuan-dana.show', compact('pengajuan'));
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return redirect()->route('pengurus.pengajuan-dana.index')
