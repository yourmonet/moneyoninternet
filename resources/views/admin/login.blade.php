...
<title>Login | Admin - {{ app_setting('app_name', 'MONET') }}</title>
    ...
    <section class="hidden lg:flex flex-col justify-between p-12 bg-surface-container-low relative overflow-hidden">
        <div class="relative z-10">
            ...
            <p class="text-on-surface-variant max-w-sm leading-relaxed">
                Silahkan masuk ke akun Anda untuk mengakses dashboard admin.
            </p>
        </div>
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <footer class="mt-8 text-center">
                <!-- <p class="text-sm text-on-surface-variant">
                    Sistem ini dilindungi. Akses terbatas hanya untuk Administrator.
                </p> -->
            </footer>
        </div>
    </section>
