...
<title>Login - {{ app_setting('app_name', 'MONET') }}</title>
    ...
    <section class="hidden lg:flex flex-col justify-between p-12 bg-surface-container-low relative overflow-hidden">
        <div class="relative z-10">
            ...
            <h1 class="font-headline text-4xl font-bold text-on-surface leading-tight mb-6">
                Selamat Datang <br/><span class="text-primary">di {{ app_setting('app_name', 'MONET') }}!</span>
            </h1>
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <footer class="mt-8 text-center">
                <p class="text-sm text-on-surface-variant">
                    Belum punya akun?
                    <a class="font-bold text-primary hover:underline underline-offset-4 ml-1" href="/register">Buat akun</a> sekarang!
                </p>
            </footer>
        </div>
    </section>
