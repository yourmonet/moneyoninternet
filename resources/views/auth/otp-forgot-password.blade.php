...
<title>Lupa Password | {{ app_setting('app_name', 'MONET') }}</title>
...
<main class="w-full max-w-md bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0px_12px_32px_rgba(25,28,30,0.04)] ring-1 ring-outline-variant/10 p-8 md:p-12">
    ...
    <header class="mb-8 text-center">
        <h2 class="font-headline text-2xl font-bold text-on-surface mb-2">Lupa Password</h2>
        <p class="text-on-surface-variant text-sm">Masukkan email Anda untuk menerima kode reset password.</p>
    </header>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-on-surface-variant">
            Ingat password Anda? 
            <a href="/" class="font-bold text-primary hover:underline underline-offset-4 ml-1">Kembali ke Beranda</a>
        </p>
    </div>
</main>
</body>
